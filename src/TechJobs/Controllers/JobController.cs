...
namespace TechJobs.Controllers
{
    public class JobController : Controller
    {
        ...
        public IActionResult Index(int id)
        {
            ...
            var aJob = jobData.Find(id);

            SearchJobsViewModel aJobFieldsViewModel = new SearchJobsViewModel(aJob);
           
            return View(aJobFieldsViewModel);
        }
        ...
        public IActionResult New(NewJobViewModel newJobViewModel)
        {
            ...
            if (ModelState.IsValid)
            {
                Job newJob = new Job
                {
                    ...
                    CoreCompetency = jobData.CoreCompetencies.Find(newJobViewModel.CoreComp),
